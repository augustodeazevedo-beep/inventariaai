          ...
          <footer className="border-t border-border py-5 px-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
              <div className="text-center sm:text-left">
                <p className="text-xs text-muted-foreground">Inventaria.AI — Sistema de Gestão de Inventário com IA</p>
                <p className="text-[10px] text-muted-foreground/60">Da triagem à sentença em uma única plataforma</p>
              </div>
